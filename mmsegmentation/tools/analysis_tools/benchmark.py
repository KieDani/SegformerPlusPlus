...
def main():
    ...
    for time_index in range(repeat_times):
        ...
        num_warmup = 15
        pure_inf_time = 0
        total_iters = 200  # 200 cityscapes
    ...
    benchmark_dict['fps_std'] = round(np.std(overall_fps_list), 4)
    benchmark_dict['median'] = round(np.median(overall_fps_list), 4)
    print(cfg.filename, ':')
    print(f'Average fps of {repeat_times} evaluations: '
          f'{benchmark_dict["average_fps"]}')
    print(f'The variance of {repeat_times} evaluations: '
          f'{benchmark_dict["fps_variance"]}')
    print(f'The standard deviation of {repeat_times} evaluations: '
          f'{benchmark_dict["fps_std"]}')
    print(f'Median fps of {repeat_times} evaluations: '
          f'{benchmark_dict["median"]}')
